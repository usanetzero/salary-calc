    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/90 via-primary to-primary/80 text-white py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Badge className="mb-4 bg-white/20 text-white border-white/30">
            {state.stateCode} &bull; {state.totalCities} Cities &bull; 2026 Data
          </Badge>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-xs text-muted-foreground mb-1">Avg Rent</div>
              <div className="text-2xl font-bold">
            ...
            <CardContent className="p-8">
              ...
              <div className="prose prose-sm text-muted-foreground max-w-none space-y-3">
                <p>
                  ...
                  the national average. With {state.totalCities} cities tracked
                  in our database, the state offers a wide range of living
                  situations from very affordable small towns to pricier
                  metropolitan areas.
                </p>
                <p>
